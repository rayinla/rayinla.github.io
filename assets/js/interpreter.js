    ...
    var wrapper = (function(nativeFunc) {
      return function(str) {
        try {
          ...
          thisInterpreter.throwException(thisInterpreter.URI_ERROR, 'URIError: ' + e.message);
        }
      };
    })(strFunctions[i][0]);
    ...
    if (argsStr) {
      ...
      for (var i = 0; i < args.length; i++) {
        ...
        if (!identifierRegexp.test(name)) {
          thisInterpreter.throwException(thisInterpreter.SYNTAX_ERROR, 'SyntaxError: ' +
  ...
  wrapper = function(thisArg, args) {
    ...
    if (args !== null && args !== undefined) {
      if (args.isObject) {
        ...
        thisInterpreter.throwException(thisInterpreter.TYPE_ERROR, 'TypeError: ' +
  ...
  wrapper = function(var_args) {
    ...
    if (arguments.length === 1 && typeof first === 'number') {
      if (isNaN(Interpreter.legalArrayLength(first))) {
        thisInterpreter.throwException(thisInterpreter.RANGE_ERROR, 'RangeError : ' +
...
Interpreter.prototype.initJSON = function(scope) {
  ...
  var wrapper = function(text) {
    try {
      ...
      thisInterpreter.throwException(thisInterpreter.SYNTAX_ERROR, "SyntaxError: " + e.message);
    }
...
Interpreter.prototype.getProperty = function(obj, name) {
  ...
  if (obj === undefined || obj === null) {
    this.throwException(this.TYPE_ERROR,
                        "TypeError:  " + "Cannot read property '" + name + "' of " + obj);
  }
  if (name === 'length') {
...
Interpreter.prototype.setProperty = function(obj, name, value, opt_descriptor) {
  ...
  if (obj === undefined || obj === null) {
    this.throwException(this.TYPE_ERROR,
                       "TypeError: " +  "Cannot set property '" + name + "' of " + obj);
  }
  ...
  if (!obj.isObject) {
    if (strict) {
      this.throwException(this.TYPE_ERROR, "TypeError: " + "Can't create property '" + name +
                          "' on '" + obj + "'");
    }
    return;
  }
  if (this.isa(obj, this.STRING)) {
    ...
    if (name === 'length' || (!isNaN(n) && n < String(obj).length)) {
      ...
      if (strict) {
        this.throwException(this.TYPE_ERROR, "TypeError: " + "Cannot assign to read only " +
  ...
  if (obj.class === 'Array') {
    ...
    if (name === 'length') {
      ...
      if (isNaN(value)) {
        this.throwException(this.RANGE_ERROR, 'RangeError : ' + 'Invalid array length');
      }
      if (value < length) {
  ...
  if (obj.preventExtensions && !(name in obj.properties)) {
    if (strict) {
      this.throwException(this.TYPE_ERROR, "TypeError: " + "Can't add property '" + name +
  ...
  if (opt_descriptor) {
    ...
    try {
      ...
      this.throwException(this.TYPE_ERROR, "TypeError: " + 'Cannot redefine property: ' + name);
    }
  } else {
    // Set the property.
    ...
    if (defObj.getter && defObj.getter[name]) {
      if (strict) {
        this.throwException(this.TYPE_ERROR, "TypeError: " + "Cannot set property '" + name +
...
Interpreter.prototype.getValueFromScope = function(name) {
  ...
  this.throwException(this.REFERENCE_ERROR, "ReferenceError: " + name +  ' is not defined');
};
  ...
  switch (node['operator']) {
    ...
    case 'instanceof':
      if (!this.isa(rightValue, this.FUNCTION)) {
        this.throwException(this.TYPE_ERROR, "TypeError: " +
...
Interpreter.prototype['stepCallExpression'] = function(stack, state, node) {
  ...
  if (!state.doneArgs_) {
    ...
    if (node['type'] === 'NewExpression') {
      if (func.illegalConstructor) {
        // Illegal: new escape();
        this.throwException(this.TYPE_ERROR, 'TypeError: ' + func + ' is not a constructor');
      }
  ...
  if (!state.doneExec_) {
    ...
    if (!func || !func.isObject) {
      this.throwException(this.TYPE_ERROR, 'TypeError: ' + func + ' is not a function');
    }
    ...
    if (funcNode) {
      ...
      if (typeof code !== 'string') {
        ...
        try {
          ...
          // Acorn threw a SyntaxError.  Rethrow as a trappable error.
          this.throwException(this.SYNTAX_ERROR, 'SyntaxError: Invalid code: ' + e.message);
            }
      ...
      f();
      */
      this.throwException(this.TYPE_ERROR, 'TypeError: ' + func.class + ' is not a function');
    }
  } else {
  ...
  if (!state.doneInit_) {
    ...
    if (node['left']['declarations'] &&
      ...
      if (state.scope.strict) {
        this.throwException(this.SYNTAX_ERROR,'SyntaxError: ' +
